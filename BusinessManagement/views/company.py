...
def add():
    if request.method == "POST":
        ...
        # checking the validity of state and country
        if data["state"]:
            try:
        ...
        if request.method == "POST":
            ...
            if not has_error:
                try:
                    ...
                    print(tb.format_exc())
                    flash(f"Unexpected error while editing the companu details", "danger")
        row = None
        try:
            # rr284 April 10 2023
            ...
            print(tb.format_exc())
            flash(f"Unexpected error while fetching the updated company details", "danger")
...
def delete():
    ...
    if request.method == "GET":
        ...
        try:
            ...
            if Fix_Constarint.status and result.status:
